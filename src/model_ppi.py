...
def create_model(max_pro_seq_len, add_structure, add_goterm, task_type):
    ...
    model = Predictor(seq_encoder, struc_encoder, seq_struc_fusion, goterm_encoder, pro_go_cross_fusion, pro_pro_cross_fusion, regression_layer, add_structure, add_goterm)
