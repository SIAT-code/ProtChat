...
class MultiLabelClassificationLayer(nn.Module):
...
def create_model(max_pro_seq_len, add_structure, add_goterm, task_type):
    ...
    if task_type in ['stability', 'fluorescence']:
        ...
        regression_layer = ClassificationLayer(seq_hid_dim, 1195)
    elif 'secondary' in task_type or 'structure' in task_type:
        regression_layer = MultiLabelClassificationLayer(seq_hid_dim, 3)
    elif 'antigen' in task_type or 'binding' in task_type:
